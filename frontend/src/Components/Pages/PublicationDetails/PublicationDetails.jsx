...
function PublicationDetails() {
    ...
    useEffect(()=>{
        ...
        getNews(params.id).then(news=>setPublication(news))
    },[params.id])
                        ...
                        <div class="align-items-center justify-content-center g-0 row"> 
                            <div> 
                                <div class="bg-light rounded text-secondary"> 
                                    <h4 class="bg-gradient bg-success fw-bold mb-0 pb-3 pe-2 ps-2 pt-3 text-uppercase text-white">{Publication?.title}</h4>
                                            ...
                                            <div class="row"> 
                                                <div class="col-lg-12"> 
                                                    ...
                                                    <p style={{textAlign:"justify"}} >
                                                        <img src={Publication?.image_url} style={{float:"left", margin: "7px 50px 7px 0"}} class="img-fluid" alt="..." width="540" height="360"/>
                                                         {Publication?.caption}
                                                        </p>
